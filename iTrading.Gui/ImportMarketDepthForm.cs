namespace iTrading.Gui
{
    ...
    /// </summary>
    public class ImportMarketDepthForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.okButton.Location = new Point(0xc0, 120);
            ...
            base.ClientSize = new Size(0x1d2, 0x9f);
            ...
            base.Name = "ImportMarketDepthForm";
            base.ShowInTaskbar = false;
            this.Text = "Import market depth data";
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        symbol.MarketDepth.Load(this.fileTextBox.Text);
