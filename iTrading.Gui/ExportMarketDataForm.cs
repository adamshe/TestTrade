namespace iTrading.Gui
{
    ...
    /// </summary>
    public class ExportMarketDataForm : Form
    {
        ...
        private void ExportMarketDataForm_Load(object sender, EventArgs e)
        {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(ExportMarketDataForm));
            ...
            base.Name = "ExportMarketDataForm";
            base.ShowInTaskbar = false;
            this.Text = "Export market data";
            base.Load += new EventHandler(this.ExportMarketDataForm_Load);
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        symbol.MarketData.Dump(this.fromDateTimePicker.Value, this.toDateTimePicker.Value, this.fileTextBox.Text);
