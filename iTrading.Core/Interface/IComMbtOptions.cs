namespace iTrading.Core.Interface
{
    ...
    /// <summary>
    /// Defines the <see cref="T:iTrading.Core.Kernel.MbtOptions" /> public methods for early binding/intellisense.
    /// </summary>
    [Guid("BEFDA018-9D1E-4b79-A635-AF47D6C770F6")]
    public interface IComMbtOptions
    {
        /// <summary>
        /// Identifies the broker or data provider. Default = <see cref="F:iTrading.Core.Kernel.ProviderTypeId.MBTrading" />
        /// </summary>
